...
import github.zmilla93.core.ninja.NinjaEndpoint;
import github.zmilla93.core.utility.DesignerCopyMonitor;
import github.zmilla93.core.utility.HttpRequester;
        ...
        for (NinjaEndpoint endpoint : NinjaEndpoint.values()) {
            for (PathOfExileLeague league : PathOfExileLeague.values()) {
                ...
                executor.submit(() -> {
                    ...
                    BufferedWriter writer = ZUtil.getBufferedWriter(SaveManager.getNinjaDirectory().resolve(league + File.separator + endpoint.type + ".json").toString());
                    try {
