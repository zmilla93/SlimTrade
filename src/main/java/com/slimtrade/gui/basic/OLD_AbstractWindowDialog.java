...
//	public IconButton_REMOVE closeButton = new IconButton_REMOVE("icons/close.png", titlebarHeight, titlebarHeight);
	protected IconButton closeButton = new IconButton("icons/close.png", titlebarHeight);
