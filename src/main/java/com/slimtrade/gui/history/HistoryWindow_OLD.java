...
public class HistoryWindow_OLD extends ResizableWindow {
	...
	private ArrayList<HistoryRowPanel_OLD> incomingTradePanels = new ArrayList<HistoryRowPanel_OLD>();
	private ArrayList<TradeOffer> outgoingTradeData = new ArrayList<TradeOffer>();
	private ArrayList<HistoryRowPanel_OLD> outgoingTradePanels = new ArrayList<HistoryRowPanel_OLD>();
...
//		this.resizeWindow(width, height);
		...
		incomingContainer.setPreferredSize(new Dimension((int) (width * 0.9), HistoryRowPanel_OLD.height * maxTrades));
		outgoingContainer.setLayout(new BoxLayout(outgoingContainer, BoxLayout.PAGE_AXIS));
		outgoingContainer.setPreferredSize(new Dimension((int) (width * 0.9), HistoryRowPanel_OLD.height * maxTrades));
	...
	public void addTrade(TradeOffer trade, boolean updateUI) {
		...
		case INCOMING_TRADE:
			...
			if (updateUI) {
				incomingTradePanels.add(new HistoryRowPanel_OLD(trade));
		...
		case OUTGOING_TRADE:
			...
			if (updateUI) {
				outgoingTradePanels.add(new HistoryRowPanel_OLD(trade));
