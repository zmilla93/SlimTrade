...
public class BasicIconButton_REMOVE extends JPanel{
	...
	public BasicIconButton_REMOVE(String imgPath, int w, int h){
...
//		BasicIconButton.height = height;
	...
	public BasicIconButton_REMOVE(String imgPath){
		curWidth = width;
		curHeight = height;
