...
public class IconButton_REMOVE extends JPanel{
	...
	public IconButton_REMOVE(String imgPath, int width, int height){
		IconButton_REMOVE.width = width;
		IconButton_REMOVE.height = height;
		buildButton();
		this.setCustomIcon(imgPath);
	}
	
	public IconButton_REMOVE(String imgPath){
		buildButton();
		this.setCustomIcon(imgPath);
	}
