...
public class ScannerPanel extends AbstractTutorialPanel {
    ...
    private JLabel info1 = new JLabel("The chat scanner can be used to search for custom phrases.");
    private JLabel info2 = new JLabel("Multiple search presets can be made with custom responses for each.");
    private JLabel info3 = new JLabel("Chat scanner message are orange.");
