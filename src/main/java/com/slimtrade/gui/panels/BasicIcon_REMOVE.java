...
public class BasicIcon_REMOVE extends JPanel{
	...
	public BasicIcon_REMOVE(String imgPath, int width, int height){
		BasicIcon_REMOVE.width = width;
		BasicIcon_REMOVE.height = height;
		buildIcon();
		this.setCustomIcon(imgPath);
	}
	
	public BasicIcon_REMOVE(String imgPath){
		buildIcon();
		this.setCustomIcon(imgPath);
	}
