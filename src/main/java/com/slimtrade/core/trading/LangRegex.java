...
public enum LangRegex {
    ...
    ENGLISH("like to buy", "has joined the area\\.", "You have entered (?<zone>.+)\\.", new String[]{
    ...
    FRENCH("t'acheter", "a rejoint la zone\\.", null, new String[]{
    ...
    GERMAN("ich möchte", "hat das Gebiet betreten\\.", null, new String[]{
    ...
    KOREAN("올려놓은", null, null, new String[]{
    ...
    PORTUGUESE("eu gostaria de comprar", "entrou na área\\.", null, new String[]{
    ...
    RUSSIAN("хочу купить у вас", "присоединился\\.", null, new String[]{
    ...
    SPANISH("comprar tu", "se unió al área\\.", null, new String[]{
    ...
    THAI("เราต้องการจะชื้อของคุณ", "เข้าสู่พื้นที่\\.", null, new String[]{
    ...
    LangRegex(String wantToBuy, String joinedArea, String enteredArea, String[] messages) {
