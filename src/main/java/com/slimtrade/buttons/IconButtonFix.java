...
public class IconButtonFix extends JPanel{
...
//	private Border border = BorderFactory.createEmptyBorder();
	...
	public IconButtonFix(String imgPath, int width, int height){
		IconButtonFix.width = width;
		IconButtonFix.height = height;
		buildButton();
		this.setCustomIcon(imgPath);
	}
	
	public IconButtonFix(String imgPath){
		IconButtonFix.width = defaultSize;
		IconButtonFix.height = defaultSize;
		buildButton();
		this.setCustomIcon(imgPath);
	}
